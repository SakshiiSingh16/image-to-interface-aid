...
export const MovingTrack = ({ name, direction, mainTrain, nearbyTrains, status, signalLeft, signalRight, onSignalClick }: MovingTrackProps) => {
  ...
  return (
    <div className="relative py-6 flex items-center gap-4 h-full">
      {/* Track Name Label */}
      ...
      <div className="flex-1 relative overflow-hidden h-48">
          ...
          >
            <div className="relative">
              ...
              <div className="absolute -top-5 left-1/2 -translate-x-1/2 text-foreground animate-pulse">
                {train.direction === "UP" ? <ArrowLeft className="w-4 h-4" strokeWidth={3} /> : <ArrowRight className="w-4 h-4" strokeWidth={3} />}
              </div>
              {/* Distance Label */}
        ...
        >
          {/* Direction Arrow - Moved Above Details */}
          <div className="text-foreground animate-pulse mb-1">
            {mainTrain.direction === "UP" ? <ArrowLeft className="w-6 h-6" strokeWidth={3} /> : <ArrowRight className="w-6 h-6" strokeWidth={3} />}
          </div>
